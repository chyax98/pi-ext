...
const STRUCTURED_OUTPUT_INSTRUCTIONS = [
	"This subagent step may capture optional structured output.",
	"If convenient, call the `structured_output` tool with JSON matching the provided schema.",
	"Prose-only completion remains valid; parent will ignore missing or invalid structured output.",
].join("\n");
